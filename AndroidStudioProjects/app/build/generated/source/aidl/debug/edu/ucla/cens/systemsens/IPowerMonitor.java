 ...
 * Original file: /home/raok/AndroidResearch/CrowdSensing/AndroidStudioProjects/app/src/main/aidl/edu/ucla/cens/systemsens/IPowerMonitor.aidl
 */
...
edu.ucla.cens.systemsens.IApplication _arg0;
_arg0 = edu.ucla.cens.systemsens.IApplication.Stub.asInterface(data.readStrongBinder());
int _arg1;
_arg1 = data.readInt();
...
/**
     ...
     */
@Override public void register(edu.ucla.cens.systemsens.IApplication app, int horizon) throws android.os.RemoteException
{
...
/**
     ...
     * @param   app     An implementation of IApplication
     */
@Override public void unregister(edu.ucla.cens.systemsens.IApplication app) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     * @param   app     An implementation of IApplication
     */
public void register(edu.ucla.cens.systemsens.IApplication app, int horizon) throws android.os.RemoteException;
/**
     * Unregister the application with power monitor
     *
     * @param   app     An implementation of IApplication
     */
public void unregister(edu.ucla.cens.systemsens.IApplication app) throws android.os.RemoteException;
/**
     * Set the battery deadline for the phone.
     * 
     * @param   deadline    deadline in minutes from now
